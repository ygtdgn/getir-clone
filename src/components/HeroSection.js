...
export default function HeroSection(){
  ...
  const phones = {
    ...
    const settings = {
      ...
      return (
        <div className="relative h-[500px] md:h-[500px] before:bg-gradient-to-r before:from-primary-brand-color before:to-transparent before:absolute before:inset-0 before:w-full before:h-full before:z-10">
        <Slider {...settings}>
            <div>
         ...
         <div className="w-[400px] rounded-lg bg-gray-50 p-6">
          ...
          <div className="flex gap-x-2">
            ...
            <label className="flex-1 relative block group cursor-pointer">
              ...
              <span className="absolute top-0 left-0 h-full px-4 flex items-center text-sm text-gray-500 peer-focus:h-7 transition-all peer-focus:text-primary-brand-color peer-focus:text-xs peer-valid:h-7 peer-valid:text-primary-brand-color peer-valid:text-xs">Telefon Numarasi</span>
            </label>
          </div>
