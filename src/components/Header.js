...
export default function Header(){
    return(
        <div className="bg-brand-color ">
            ...
            <div className="container md:hidden mx-auto bg-white flex items-center h-10 px-3 justify-between">
